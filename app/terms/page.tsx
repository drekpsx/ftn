...
export const metadata = { title: 'Conditions générales — Flotik' };
    ...
    <div>
      ...
      <div className="mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="prose prose-sm mt-8 max-w-none text-gray-600">
          <h2>1. Objet</h2>
          <p>
            Flotik est une plateforme SaaS permettant aux micro-entrepreneurs de recevoir des demandes, créer
            des devis et gérer leurs clients depuis une page publique personnalisée.
          </p>

          <h2>2. Compte utilisateur</h2>
          <p>
            L&apos;utilisation de Flotik nécessite la création d&apos;un compte. Vous êtes responsable de la
            confidentialité de vos identifiants et de toute activité effectuée depuis votre compte.
          </p>

          <h2>3. Forfaits et facturation</h2>
          <p>
            Flotik propose un forfait gratuit ainsi que des forfaits payants (Starter, Pro) facturés
          ...
          <p>
            Vous vous engagez à utiliser Flotik conformément à la loi, à ne pas diffuser de contenu illicite
            sur votre page publique, et à ne pas tenter de compromettre la sécurité du service.
          </p>

          <h2>5. Responsabilité</h2>
          <p>
            Flotik est un outil de gestion. Les relations commerciales, la qualité des prestations et le
          ...
          <h2>6. Paiements</h2>
          <p>
            Les paiements (acomptes, abonnements) sont traités par Stripe. Flotik ne stocke jamais vos
            informations bancaires.
          </p>

          <h2>7. Résiliation</h2>
          <p>
            Vous pouvez supprimer votre compte à tout moment depuis les paramètres. Flotik se réserve le droit
